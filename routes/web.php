...
Route::middleware(['auth'])->group(function () {
    ...
    Route::put('/account-order/cancel-order', [UserController::class,'orders_cancel'])->name('user.order-cancel');
});

Route::middleware(['auth', AuthAdmin::class])->group(function () {
    Route::get('/admin', [AdminController::class, 'index'])->name('admin.index');
    Route::get('/admin/labels', [AdminController::class, 'labels'])->name('admin.labels');
    Route::get('/admin/labels/add', [AdminController::class, 'add_label'])->name('admin.label-add');
    Route::post('/admin/labels/store', [AdminController::class, 'label_store'])->name('admin.label-store');
    Route::get('/admin/labels/edit/{id}', [AdminController::class, 'label_edit'])->name('admin.label-edit');
    Route::put('/admin/labels/update', [AdminController::class, 'label_update'])->name('admin.label-update');
    Route::delete('/admin/labels/{id}/delete', [AdminController::class, 'label_delete'])->name('admin.label-delete');
    ...
    Route::delete('admin/coupon/delete/{id}', [AdminController::class, 'coupon_delete'])->name('admin.coupon-deleted');
    ...
    Route::delete('/admin/contact/delete/{id}', [AdminController::class,'contacts_delete'])->name('admin.contact-delete');
