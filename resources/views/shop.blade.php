...
@section('content')
                                        ...
                                        <li class="list-item">
                                            <span class="menu-link py-1">
                                                <input type="checkbox" name="labels" value="{{ $label->id }}"
                                                    class="chk-label"
                                                    @if (in_array($label->id, explode(',', $f_labels))) checked="checked" @endif>
                                                {{ $label->name }}
                                            </span>
                    ...
                    <div class="accordion-item mb-4">
                        ...
                        <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value=""
                                data-slider-min="1" data-slider-max="200" data-slider-step="5"
                            ...
                            <div class="price-range__info d-flex align-items-center mt-2">
                                ...
                                <div>
                                    ...
                                    <span class="price-range__max">Rp200</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="slide-split_text position-relative d-flex align-items-center"
                                    ...
                                    <div class="slideshow-text container p-3 p-xl-5">
                                        <h2
                                            ...
                                            Fresh Vegetables Direct <br /><strong>from Farmers</strong></h2>
                                        <p class="mb-0 animate animate_fade animate_btt animate_delay-5">Pilihan sayuran
                                            dan hasil tani berkualitas, dipanen segar setiap hari dan dikirim langsung dari
                                            petani terpercaya.</h6>
                                    </div>
                                </div>
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy" src="assets/images/shop/veggies_banner.jpg" width="630"
    ...
    <form id="frmfilter" method="GET" action="{{ route('shop.index') }}">
        ...
        <input type="hidden" name="labels" id="hdnLabels" />
...
@push('scripts')
    <script>
        $(function() {
            ...
            $("input[name='labels']").on("change", function() {
                var labels = "";
