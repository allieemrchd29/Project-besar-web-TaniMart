                    ...
                    <form name="contact-us-form" class="needs-validation" novalidate=""
                        ...
                        <div class="form-floating my-4">
                            <input type="text" class="form-control" name="phone" placeholder="Phone *"
                                value="{{ old('phone') }}" value="{{ old('name') }}" required="">
                        ...
                        <div class="my-4">
                            <textarea class="form-control form-control_gray" name="comment" placeholder="Write Your Message *" cols="30"
                                rows="8" required="">{{ old('name') }}</textarea>
                            @error('comment')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
