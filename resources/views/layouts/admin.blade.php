        ...
        <div id="page" class="">
            <div class="layout-wrap">
                ...
                <div class="section-menu-left">
                    <div class="box-logo" style="background-color: #acce66">
                        <a href="{{ route('admin.index') }}" id="site-logo-inner">
                            <img class="" id="logo_header_1" alt=""
                                src="{{ asset('assets/images/banner_tanimart.png') }}"
                                data-light="{{ asset('assets/images/banner_tanimart.png') }}"
                                data-dark="{{ asset('assets/images/banner_tanimart.png') }}">
                        </a>
                        ...
                        <div class="center-item">
                            <ul class="menu-list">
                                ...
                                <li class="menu-item has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.label-add') }}" class="">
                                                <div class="text">New Label</div>
                                            </a>
                                        </li>
                                        <li class="sub-menu-item">
                                            <a href="{{ route('admin.labels') }}" class="">
                ...
                <div class="section-content-right">
                            ...
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_1" alt=""
                                        ...
                                        data-retina="{{ asset('assets/images/banner_tanimart.png') }}">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
                    ...
                    <div class="main-content">
                        ...
                        <div class="bottom-page">
                            <div class="body-text">Copyright ©2025 TaniMart by Yaya</div>
                        </div>
                    </div>
