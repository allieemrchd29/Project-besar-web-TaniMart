                                    ...
                                    <div class="wg-box">
                                        ...
                                        <div class="gap22 cols">
                                            ...
                                            <fieldset class="label">
                                                ...
                                                <div class="select">
                                                    <select class="" name="label_id">
                                                        <option>Choose Label</option>
                                                        @foreach ($labels as $label)
                                                            <option value="{{ $label->id }}" {{ $product->label_id == $label->id ? "selected" : "" }}>{{ $label->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </fieldset>
                                            ...
                                            <fieldset class="name">
                                                ...
                                                <div class="select mb-10">
                                                    <select class="" name="stock_status">
                                                        ...
                                                        <option value="lowstock" {{ $product->stock_status == 'lowstock' ? 'selected' : '' }}>Low Stock</option>
